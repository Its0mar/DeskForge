...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    private RefreshToken(string token, Guid userId, DateTimeOffset expiresOnUtc)
    {
        Token = token;
        UserId = userId;
    ...
    public static Result<RefreshToken> Create(Guid userId, DateTimeOffset expiresOnUtc)
    {
